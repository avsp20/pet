...
data-asset-path="{{ asset('/')}}">
  ...
  @php
    $class = "";
  @endphp
  @if(request()->route()->getName() == "customers.edit" || request()->route()->getName() == "customers.create" || request()->route()->getName() == "customers-pet-edit" || request()->route()->getName() == "customers-pet-create")
    @php
