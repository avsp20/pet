...
<div class="navbar-container d-flex content">
  <ul class="nav navbar-nav align-items-center ms-xl-auto menu-bar">
        ...
        <li class="scrollable-container media-list">
          <a class="d-flex" href="javascript:void(0)">
            <div class="list-item d-flex align-items-start">
              <div class="me-1">
                <div class="avatar">
                  <img src="{{ asset('public/images/portrait/small/avatar-s-15.jpg') }}" alt="avatar" width="32"
                    height="32">
                </div>
              </div>
          ...
          <a class="d-flex" href="javascript:void(0)">
            <div class="list-item d-flex align-items-start">
              <div class="me-1">
                <div class="avatar">
                  <img src="{{ asset('public/images/portrait/small/avatar-s-3.jpg') }}" alt="avatar" width="32" height="32">
                </div>
              </div>
              <div class="list-item-body flex-grow-1">
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <span class="avatar">
          <img class="round"
            src="{{ Auth::user() ? ((Auth::user()->profile_image != null) ? asset('public/images/user_profiles/'.Auth::user()->profile_image) : asset('public/images/no-user.png')) : asset('public/images/portrait/small/avatar-s-11.jpg') }}"
...
<ul class="main-search-list-defaultlist d-none">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
      <div class="d-flex">
        <div class="me-75">
          <img src="{{ asset('public/images/icons/xls.png') }}" alt="png" height="32">
        </div>
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
      <div class="d-flex">
        <div class="me-75">
          <img src="{{ asset('public/images/icons/jpg.png') }}" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
      <div class="d-flex">
        <div class="me-75">
          <img src="{{ asset('public/images/icons/pdf.png') }}" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
      <div class="d-flex">
        <div class="me-75">
          <img src="{{ asset('public/images/icons/doc.png') }}" alt="png" height="32">
        </div>
        <div class="search-data">
    ...
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="{{ url('app/user/view') }}">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="{{ asset('public/images/portrait/small/avatar-s-8.jpg') }}" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="{{ url('app/user/view') }}">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="{{ asset('public/images/portrait/small/avatar-s-1.jpg') }}" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="{{ url('app/user/view') }}">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="{{ asset('public/images/portrait/small/avatar-s-14.jpg') }}" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="{{ url('app/user/view') }}">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="{{ asset('public/images/portrait/small/avatar-s-6.jpg') }}" alt="png" height="32">
        </div>
        <div class="search-data">
