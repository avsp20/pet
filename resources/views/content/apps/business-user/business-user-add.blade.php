  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form" enctype="multipart/form-data" method="POST" action="{{ route('businesses.store') }}">
          @csrf
          <!-- header section -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <a href="{{ route('businesses.index') }}" class="btn btn-danger mt-1 me-1">Cancel</a>
            </div>
          </div>
        </form>
        <!--/ form -->
